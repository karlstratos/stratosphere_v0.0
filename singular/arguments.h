...
//
// Class for processing user-specified arguments for Singular.

#ifndef SINGULAR_ARGUMENTS_H_
#define SINGULAR_ARGUMENTS_H_
...
public:
    // Parses the command line strings into arguments.
    ...
    // Returns whether there is a sentence per line in the text corpus.
